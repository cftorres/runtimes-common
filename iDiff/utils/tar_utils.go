...
// Enlists "deep" contents (i.e. recursively obtains nested files and directories) based on
// deep argument specifier, otherwise only enlists "shallow" contents of a directory.
